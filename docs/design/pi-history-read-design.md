...
`PiUIMessage[]`（`PiUserUIMessage | PiAssistantUIMessage` 与 `PiTools`）到裸 `UIMessage[]` 的可赋值性即可；
...
| assistant `usage` / `cost` / `model` / `provider` / `stopReason`                                                         | `message.metadata`（`PiAssistantMetadata` 加可选字段）                    | 历史比实时富，对拍允许此不对称                                                                                                                                                                                                                                                                 |
...
| 纯转换       | `packages/server/src/harness/pi/ui-message.ts`          | `PiAssistantMetadata` 加可选 usage / model / stopReason 字段                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
