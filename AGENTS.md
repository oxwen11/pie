...
| Task                                           | Read                                                                                             |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| Planning, reviewing, or accepting a change     | [Cost of correction](.agents/rules/cost-of-correction.md)                                        |
| Changing or reviewing product code             | [Architecture](.agents/rules/architecture.md), [stack constraints](.agents/rules/stack.md)       |
| Adding or changing host writes                 | Host-write design gate in [architecture](.agents/rules/architecture.md), before proposing a plan |
...
| Refactoring or complexity review               | [Ponytail](.agents/rules/ponytail.md)                                                            |
