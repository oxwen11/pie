...
| Session queue | Frame above composer: **N queued messages**, one row each; **Edit queued message** / **Remove queued message**; steering rows labeled **Steer**; not transcript bubbles |
