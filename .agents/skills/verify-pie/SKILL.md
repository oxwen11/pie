...
- Creates `$PIE_HOME/workspace/verify-pie-sample` (marked `.verify-pie-scaffold`) and confines the project picker to `$PIE_HOME/workspace`. The picker cannot browse the host home or escape through `..` or symlinks.
