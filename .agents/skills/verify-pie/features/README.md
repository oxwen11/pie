...
Primary surface: Vite app at `http://localhost:4190/`. Drive with **agent-browser** after `eval "$(pnpm exec pie-verify web env --export)"`. Steps are in the parent `SKILL.md` Drive section and each feature file below.
