...
// The one always-on consumer of the global subscription. Each connection opens
// the stream before refreshing the lists, so events arriving during that
// refresh wait in the stream instead of falling into an uncovered gap.
