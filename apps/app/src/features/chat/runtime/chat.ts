...
export class Chat {
  ...
  // Swap in a fresh transport after idle eviction. The store, cursor, and
  // history floor stay put; the next "attached" snapshot reconciles against
  // them on the existing hydrate path.
