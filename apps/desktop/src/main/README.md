...
- `electron/` contains BrowserWindow (`MainWindow` Tag), MessageChannel (`RendererChannel` Tag), custom asset protocol adapters, and `$PIE_HOME/config.toml` `[desktop.window]` (window bounds; not Electron `userData`).
