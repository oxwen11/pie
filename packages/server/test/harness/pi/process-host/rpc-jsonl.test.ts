/* oxlint-disable pie/node-import-style */
// UPSTREAM @earendil-works/pi-coding-agent@0.84.2 packages/coding-agent/test/rpc-jsonl.test.ts
...
import {
  ...
  serializeJsonLine,
} from "../../../../src/harness/pi/process-host/jsonl";
