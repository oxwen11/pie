...
/**
 * Locating a CLI executable on PATH before spawning it. Shared by Pi, ssh, and
 * Tailscale: a PATH lookup answers "can we spawn this command" without starting
 * a process that was never going to succeed.
 *
