...
- [ ] `running` and `requires_action` are visually distinct in the sidebar
- [ ] `crashed` is visible without opening the session
- [ ] Tooltips match the actual phase semantics
- [ ] Existing tests updated; add row-level tests if missing
